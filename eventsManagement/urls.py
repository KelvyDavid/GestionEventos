...
from .views import (
    ListaEventosView, DetalleEventoView, InscribirEventoView,
    CrearEventoView, MisEventosView, CustomLoginView, 
    CustomLogoutView,  RegistroUsuarioView
)

urlpatterns = [
    path('', ListaEventosView.as_view(), name='tabla_eventos'),
